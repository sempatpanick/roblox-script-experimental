--[[
  Objects tab module for WindUI scripts.
  Reuses tabs/rayfield/objects_tab.lua logic via windui/compat.
...
local createRayfieldObjectsTab = loadRayfieldTab("objects_tab")

local function createObjectsTab(windowRef, notifyFn, options)
	return createRayfieldObjectsTab(compatMod.wrapWindow(windowRef), notifyFn, options or {})
end
