--[[
  Local Player tab module for WindUI scripts.
  Reuses tabs/rayfield/local_player_tab.lua logic via windui/compat.
...
local createRayfieldLocalPlayerTab = loadRayfieldTab("local_player_tab")

local function createLocalPlayerTab(windowRef, notifyFn, options)
	return createRayfieldLocalPlayerTab(compatMod.wrapWindow(windowRef), notifyFn, options or {})
end
