...
local games = {
	...
	[82683242850322] = baseURL .. "/games/sempat/mount_victor.lua",
	...
	[120336108521610] = baseURL .. "/games/sempat/capybara_onsen.lua",
}
...
local function loadBootstrap()
	...
	okReq, mod = pcall(require, "../functions/loader/bootstrap")
	if okReq and type(mod) == "table" and type(mod.start) == "function" then
		return mod
	end
