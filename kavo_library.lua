    ...
    function Tabs:NewTab(tabName)
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewTextBox(tname, tTip, callback, initialText)
                ...
                function TextBoxApi:Set(t)
                    programmaticText = true
                    TextBox.Text = t ~= nil and tostring(t) or ""
                    programmaticText = false
                end
                TextBoxApi.SetValue = TextBoxApi.Set
            ...
            function Elements:NewLabel(title)
            	...
            	label.Text = title
           		label.Size = UDim2.new(0, 352, 0, 0)
